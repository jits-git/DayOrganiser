/**
 * Web implementation of voice task input using the Web Speech API.
 * The .native.tsx variant uses expo-speech-recognition.
 */
...
export function VoiceTaskModal({
  ...
  function startListening() {
    ...
    if (!SR) {
      Alert.alert(
        "Not supported",
        "Speech recognition is not available in this browser. Try Chrome or Safari."
      );
      return;
    }
      ...
      <View style={[styles.container, { backgroundColor: c.background }]}>
        <View
          style={[
            styles.header,
            {
              paddingTop: Platform.OS === "ios" ? 20 : topInset + 16,
        ...
        <View style={styles.body}>
          {phase === "idle" && (
            <Animated.View entering={FadeIn} style={styles.phaseContainer}>
              <Text style={[styles.hintTitle, { color: c.foreground, fontFamily: "Inter_600SemiBold" }]}>
                Speak your task
              </Text>
              <Text style={[styles.hintSub, { color: c.mutedForeground, fontFamily: "Inter_400Regular" }]}>
                Include the date and time naturally.
              </Text>

              <View style={[styles.exampleBox, { backgroundColor: c.secondary, borderRadius: c.radius }]}>
                <Text style={[styles.exampleText, { color: c.mutedForeground, fontFamily: "Inter_400Regular" }]}>
                  "Submit the report{" "}
              ...
              <Text style={[styles.tapLabel, { color: c.mutedForeground, fontFamily: "Inter_500Medium" }]}>
                Tap to speak
              </Text>
            </Animated.View>
          )}
          ...
          {phase === "listening" && (
            <Animated.View entering={FadeIn} style={styles.phaseContainer}>
              <Text style={[styles.hintTitle, { color: c.destructive, fontFamily: "Inter_600SemiBold" }]}>
                Listening...
              </Text>
          ...
          {phase === "review" && parsed && (
            <Animated.View entering={FadeInDown.duration(300)} style={styles.phaseContainer}>
              <View
                style={[
                  styles.successIcon,
              ...
              <View style={styles.reviewCards}>
                <ReviewRow icon="file-text" label="Task" value={parsed.description} colors={c} />
                <ReviewRow
                  icon="clock"
                  label="Target"
              ...
              <Text style={[styles.reviewNote, { color: c.mutedForeground, fontFamily: "Inter_400Regular" }]}>
              ...
              <View style={styles.reviewButtons}>
                ...
                >
                  ...
                  <Text style={[styles.retryText, { color: c.foreground, fontFamily: "Inter_500Medium" }]}>
                    Try again
                  </Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={[styles.confirmText, { color: c.primaryForeground, fontFamily: "Inter_600SemiBold" }]}>
                    Create Task
                  </Text>
                </TouchableOpacity>
              </View>
  ...
  return (
    ...
    >
      ...
      <View style={styles.reviewRowText}>
        <Text style={[styles.reviewRowLabel, { color: colors.mutedForeground, fontFamily: "Inter_400Regular" }]}>
          {label}
        </Text>
        <Text style={[styles.reviewRowValue, { color: colors.foreground, fontFamily: "Inter_600SemiBold" }]}>
          {value}
        </Text>
      </View>
    </View>
